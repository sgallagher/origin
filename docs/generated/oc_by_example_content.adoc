...
----
  ...
  oc serviceaccount/sa-name secrets/secret-name secrets/another-secret-name

  // To use your secret as an image pull secret, you must link a 'pull' secret to your service account like this:
  oc serviceaccount/sa-name secrets/secret-name --for=pull

  // To use your secret for image pulls or inside a pod:
  oc serviceaccount/sa-name secrets/secret-name --for=pull,mount
----
====
